...
<head>
    <meta charset="UTF-8">
    <title>App1 :: CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?></title>
    ...
    <header>
        ...
        <div class="menu">
            <ul>
                ...
                <li class="menu-item hidden"><a href="http://localhost:3000/ci-documentation/" target="_blank">CI
                        Docs</a>
                </li>
                <li class="menu-item hidden"><a href="/api/v1/docs" target="_blank">Swagger</a></li>
            </ul>
        </div>
    </header>
    <section>
        <h1>List All Routes</h1>
